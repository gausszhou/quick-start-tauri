  ...
  >
    <el-descriptions-item v-for="dialog in dialogs" :label="dialog.title">
      <el-button type="info" @click="infoDialog(dialog.fn)" plain
        >Info</el-button
      >
      <el-button type="warning" @click="warningDialog(dialog.fn)" plain
        >Warning</el-button
      >
      <el-button type="danger" @click="errorDialog(dialog.fn)" plain
        >Error</el-button
      >
    </el-descriptions-item>
    <el-descriptions-item label="Open" :span="2">
      <el-button type="primary" @click="openFileDialog" plain
        >选择图片</el-button
      >
      <el-tag v-if="fileName.trim() != ''">{{ fileName }}</el-tag>
    </el-descriptions-item>
    <el-descriptions-item label="Save" :span="2">
      <el-button type="primary" @click="saveFileDialog" plain
        >保存文件</el-button
      >
